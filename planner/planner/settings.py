...
SECRET_KEY = 'django-insecure-on1$$)yetu!@0(9_nkozsjzh=pr=-^jtdr1a5=-4b9pa$0=g@2'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10),  # طول عمر توکن دسترسی
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),  # طول عمر توکن بازآوری
